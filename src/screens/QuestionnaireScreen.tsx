...
import { DASS_QUESTIONS, DASS_OPTIONS, computeDass21Result, COLORS, updateQuestionnaireProfile } from '../services/dataService';
...
const saveToFirestore = async (
  ...
  await updateQuestionnaireProfile(userId, result);
};
